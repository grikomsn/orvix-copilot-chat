 ...
 *
 * Strictly opt-in via `orvixCopilot.inlineSuggestions`. The provider debounces
...
export class OrvixInlineCompletionProvider implements vscode.InlineCompletionItemProvider {
  ...
  provideInlineCompletionItems(
    ...
    // (users can opt in via orvixCopilot.inlineSuggestionsChatInput).
