...
test("keeps Orvix endpoints and request identity centralized", () => {
  ...
  assert.equal(ORVIX_ENDPOINTS.images, `${API_BASE}/images/generations`);
  assert.equal(ORVIX_GATEWAY_ENDPOINTS.imageCatalogue, `${GATEWAY_BASE}/models/catalogue`);
